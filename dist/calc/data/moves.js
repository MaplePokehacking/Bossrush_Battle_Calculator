...
var RBY = {
    ...
    'Take Down': { bp: 100, type: 'Normal', recoil: [1, 4] },
...
var GSC_PATCH = {
    ...
    Bully: { bp: 60, type: 'Dark' },
    'Triple Kick': { bp: 25, type: 'Fighting', multihit: [1, 3] },
    ...
    'Rapid Spin': { bp: 80, type: 'Normal' },
    Whirlpool: { bp: 50, type: 'Water' },
    'Zap Cannon': { bp: 60, type: 'Electric' },
    'Extreme Speed': { bp: 80, type: 'Normal', priority: 2 },
    ...
    'Pain Split': { bp: 0, category: 'Status', type: 'Psychic' },
    'Shadow Ball': { bp: 85, type: 'Ghost' },
    'Sludge Bomb': { bp: 90, type: 'Poison' },
    Spark: { bp: 60, type: 'Electric' },
...
var ADV_PATCH = {
    ...
    'Comet Punch': { makesContact: true, type: 'Steel' },
    ...
    Guillotine: { type: 'Steel', bp: 75, makesContact: true },
    Headbutt: { makesContact: true },
    'Horn Attack': { makesContact: true },
    'Drill Crush': { type: 'Steel', makesContact: true },
    ...
    Dive: { bp: 85, type: 'Water', makesContact: true },
    'Doom Desire': { bp: 140, type: 'Steel' },
    Extrasensory: { bp: 85, type: 'Psychic' },
    'Fake Out': { bp: 40, type: 'Normal', priority: 2 },
    Hail: { bp: 0, category: 'Status', type: 'Ice' },
    'Icicle Spear': { bp: 25, type: 'Ice', multihit: [2, 5] },
    'Knock Off': { bp: 75, type: 'Dark', makesContact: true },
    ...
    Uproar: { bp: 60, type: 'Normal', isSound: true },
    ...
    'Poison Fang': { bp: 60, type: 'Poison', makesContact: true },
    ...
    'Crush Claw': { bp: 90, type: 'Normal', makesContact: true },
    'Dragon Claw': { bp: 85, type: 'Dragon', makesContact: true },
    'Dragon Dance': { bp: 0, category: 'Status', type: 'Dragon' },
    Eruption: { bp: 125, type: 'Fire', target: 'allAdjacentFoes', recoil: [1, 3] },
    ...
    'Poison Tail': { bp: 75, type: 'Poison', makesContact: true },
    ...
    'Water Spout': { bp: 125, type: 'Water', target: 'allAdjacentFoes', recoil: [1, 3] },
...
var DPP_PATCH = {
    ...
    Dig: { bp: 90, category: 'Physical' },
    Dive: { bp: 85, category: 'Physical' },
    ...
    'Drill Crush': { category: 'Physical' },
    'Hyper Beam': { category: 'Special', self: { boosts: { spa: -2 } } },
    ...
    'Nature Power': { bp: 0, type: 'Normal', category: 'Physical' },
    Payback: {
        bp: 50,
        type: 'Dark',
        makesContact: true,
    ...
    'Power Gem': { bp: 85, type: 'Rock', category: 'Special', target: 'allAdjacentFoes' },
    ...
    'Mirror Shot': { bp: 50, type: 'Steel', category: 'Special' },
    ...
    'Roar of Time': { bp: 130, type: 'Dragon', category: 'Special', recoil: [1, 3] },
    'Rock Climb': {
        bp: 85,
        type: 'Rock',
        makesContact: true,
    ...
    'Attack Order': { bp: 95, type: 'Bug', category: 'Special' },
    Brine: { bp: 50, type: 'Water', category: 'Special' },
    'Bullet Punch': {
        bp: 40,
        type: 'Steel',
        priority: 1,
    ...
    'Psycho Cut': { bp: 75, type: 'Psychic', category: 'Physical' },
    'Rock Polish': { bp: 0, type: 'Rock' },
    'Rock Wrecker': { bp: 130, type: 'Rock', category: 'Physical', self: { boosts: { atk: -1, def: -1 } } },
    'Seed Bomb': { bp: 85, type: 'Grass', category: 'Physical' },
    'Shadow Claw': {
        bp: 80,
        type: 'Ghost',
        makesContact: true,
    ...
    Sonata: { type: 'Normal', category: 'Status', bp: 0, target: 'allAdjacent' },
    Flash: {
        bp: 50,
        type: 'Normal',
        category: 'Special',
    ...
    'Rip Current': { bp: 0, type: 'Water', category: 'Status' },
    'Binding Web': { bp: 0, type: 'Bug', category: 'Status' },
    'Spirit Break': {
        bp: 75,
        type: 'Fairy',
        category: 'Physical',
    ...
    'Doll Decoy': { bp: 0, type: 'Psychic', category: 'Status' },
    Boomburst: {
        bp: 130,
        type: 'Normal',
        category: 'Special',
    ...
    Adapt: { bp: 0, type: 'Fighting', category: 'Status' },
    'Magnet Shock': {
        bp: 80,
        type: 'Steel',
        category: 'Special'
    ...
    'Royal Rest': { bp: 0, type: 'Water', category: 'Status' },
    Liquidation: {
        bp: 85,
        type: 'Water',
        category: 'Physical',
    ...
    'Heat Up': { bp: 0, type: 'Fire', category: 'Status' },
    Hellfire: {
        bp: 90,
        type: 'Fire',
        category: 'Special'
    ...
    'Shadow Shield': { bp: 0, type: 'Ghost', category: 'Status' },
    Stench: {
        bp: 80,
        type: 'Poison',
        category: 'Special',
    ...
    'Tear Gas': { bp: 0, type: 'Poison', category: 'Status', priority: 1 },
    'Samba Step': {
        bp: 110,
        type: 'Water',
        category: 'Special',
    ...
    'Tail Propel': { bp: 0, type: 'Water', category: 'Status' },
    'Struggle Bug': {
        bp: 50,
        type: 'Bug',
        category: 'Special'
    ...
    Focus: { bp: 0, type: 'Psychic', category: 'Status' },
    'Power Glide': {
        bp: 85,
        type: 'Flying',
        category: 'Physical',
    ...
    Fossilize: { bp: 0, type: 'Rock', category: 'Status' },
    Switcheroo: {
        bp: 70,
        type: 'Dark',
        category: 'Special',
    ...
    'Crown Charm': { bp: 0, type: 'Normal', category: 'Status' }
};
